...
const MySelect = ({options, defaultValue, value, onChange}) => {
	{/*Двустороннее связывание и сделать компонент onChange управляемым в select. Функция onChange: передача значений, который выбрал пользователь, достаём из поля target.value*/ }
	return (
		<select
			value={value}
